...
<img width="1013" height="683" alt="image" src="https://github.com/user-attachments/assets/30e5b846-29e2-494d-b81e-70b418d9f10e" />
...
def train_model(model, train_loader, criterion, optimizer, epochs):
  ...
  for epoch in range(epochs):
    ...
    if (epoch + 1) % 10 == 0:
        print(f'Epoch [{epoch+1}/{epochs}], Loss: {loss.item():.4f}')# Initialize model
...
print("Name:Arun S")
print("Register No:212224230023")
...
### Dataset Information
<img width="1123" height="813" alt="image" src="https://github.com/user-attachments/assets/16458b7f-b09a-4347-951d-023842c7c0e8" />
